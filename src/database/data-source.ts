...
export const AppDataSource = new DataSource({
  ...
  entities: [
    User, Profile, Subject, JobRole, JobRoleSubject, UserJobRole,
    ...
    Activity, Badge, BadgeRule, UserBadge, UserStreak, UserXpLog, SkillEnrollment,
    PaymentOrder, SkillTierOffering, EnrollmentTierCapConfig, FreeLessonView,
    EnrollmentBatch,
  ],
  synchronize: false,
});
